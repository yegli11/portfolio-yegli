      ...
      <div className="flex flex-col gap-12">
        ...
        >
          ...
          <div
            ...
            style={{ background: "linear-gradient(135deg, #826DEE 0%, #EB4213 60%, #FF99DC 100%)" }}
          >
            {/* Decoration */}
            <div aria-hidden="true" className="pointer-events-none absolute inset-0 overflow-hidden">
              <div className="absolute -top-16 -right-16 h-52 w-52 rounded-full bg-white/10" />
              <div className="absolute -bottom-10 -left-10 h-44 w-44 rounded-full bg-white/8" />
              <span className="absolute right-8 bottom-8 select-none text-[120px] font-black leading-none opacity-[0.07]">✳</span>
            </div>

            <div className="relative flex flex-col items-center gap-7 text-center">
              <p className="max-w-md text-lg font-medium text-white/90 leading-relaxed">
                Mi bandeja de entrada siempre está abierta. Cuéntame tu proyecto y veamos cómo puedo ayudarte.
              </p>
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.97 }}
                className="inline-flex items-center gap-3 rounded-full px-8 py-4 text-base font-bold shadow-xl"
              ...
              <div className="flex items-center gap-4">
                {socials.map(({ label, href, bg, icon }) => (
                  <motion.a
                    ...
                    whileTap={{ scale: 0.9 }}
                    className="flex h-11 w-11 items-center justify-center rounded-full shadow-md transition-all"
