...
const HIGHLIGHT_COLORS = ["#826DEE", "#4DB8FF", "#EB4213", "#FF99DC", "#D8F382"];
  ...
  return (
    <SectionTemplate id="formacion" variant="light">
      <div className="flex flex-col gap-12">
        <SectionTitle eyebrow={e.eyebrow} title={e.title} subtitle={e.subtitle} />
        ...
        <div className="mx-auto w-full max-w-3xl">
          ...
          >
            ...
            >
              <span className="pointer-events-none absolute right-6 top-1/2 -translate-y-1/2 select-none text-[9rem] font-black leading-none opacity-[0.08] text-white" aria-hidden="true">🎓</span>
              ...
              <div>
                ...
                <p className="mt-1 text-sm font-semibold text-white/80">{e.institution}</p>
              </div>
            </div>
            ...
            <div className="bg-surface-light dark:bg-surface-dark p-7 flex flex-col gap-5">
              ...
              <div className="flex flex-wrap gap-2">
                {e.highlights.map((label, i) => {
                  const bg = HIGHLIGHT_COLORS[i % HIGHLIGHT_COLORS.length];
                  return (
                    <motion.span
                      key={label}
